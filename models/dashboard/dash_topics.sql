with cte as (SELECT parliament, `date`, member_party, b.member_constituency, member_name, topic_assigned
                        ...
                        by_parl as(
                        select cast(parliament as STRING) as parliament, member_party, member_constituency, member_name, topic_assigned, count(*) as count_topic_speeches
                        from cte
                        group by parliament, member_party, member_constituency, member_name, topic_assigned
                        ),
                        all_parl as(
                        select 'All' as parliament, member_party, 'All' as member_constituency, member_name, topic_assigned, count(*) as count_topic_speeches
                        from cte
